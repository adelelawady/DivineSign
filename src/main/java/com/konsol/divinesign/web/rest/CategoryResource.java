...
/**
 * REST controller for managing {@link com.konsol.divinesign.domain.Category}.
 */
@RestController
...
public class CategoryResource {
    ...
    public ResponseEntity<CategoryDTO> createCategory(@Valid @RequestBody CategoryDTO categoryDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/categories/" + categoryDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, categoryDTO.getId()))
            .body(categoryDTO);
    }
