...
/**
 * REST controller for managing {@link com.konsol.divinesign.domain.Tag}.
 */
@RestController
...
public class TagResource {
    ...
    public ResponseEntity<TagDTO> createTag(@Valid @RequestBody TagDTO tagDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/tags/" + tagDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, tagDTO.getId()))
            .body(tagDTO);
    }
