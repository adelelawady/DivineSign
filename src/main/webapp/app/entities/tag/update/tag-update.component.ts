...
export class TagUpdateComponent implements OnInit {
  ...
  protected updateForm(tag: ITag): void {
    ...
    this.splendsSharedCollection = this.splendService.addSplendToCollectionIfMissing<ISplend>(this.splendsSharedCollection, tag.splend);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.splendService
      ...
      .pipe(map((splends: ISplend[]) => this.splendService.addSplendToCollectionIfMissing<ISplend>(splends, this.tag?.splend)))
